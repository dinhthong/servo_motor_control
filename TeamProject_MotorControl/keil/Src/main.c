...
float KP,KI,KD,Ts=0.015,ek2,ek1,ek,uk,uk1,umax=20000,umin=-20000,u,setpoint,measure,tam3;
  ...
  while (1)
  {
		...
		//	Xu ly du lieu
			if((a=='V')|(a=='X'))
			{
				...
				KP=(float)(data[2]*10000+data[3]*1000+data[4]*100+data[6]*10+data[7])/100;
				KI=(float)(data[9]*10000+data[10]*1000+data[11]*100+data[13]*10+data[14])/100;
				KD=(float)(data[16]*10000+data[17]*1000+data[18]*100+data[20]*10+data[21])/100;
				setpoint=(float)(data[23]*10000+data[24]*1000+data[25]*100+data[27]*10+data[28])/100;
			}
			else 
			{
				KP=0;KI=0;KD=0;setpoint=0;u=0;oo=0;
	...
	if(a=='X')
	{
		...
		HAL_Delay(15);
		//float KP=5,KI=3,KD=0.03,Ts=0.015,ek2,ek1,ek,uk,uk1,umax=20000,umin=-20000,u,setpoint=180,measure;
	...
	if(a=='V')
	{
		...
		if(b=='@') uu=setpoint;
		//PID_speed_controll
		//float KP=50,KI=500,KD=15,Ts=0.015,ek2,ek1,ek,uk,uk1,umax=20000,umin=-20000,u,setpoint=200,measure;
		HAL_Delay(15);
		measurep=(float)((int)count%3540);
		oo=measurep*360/3540;
		u=speed();
